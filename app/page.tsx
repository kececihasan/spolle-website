          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              ...
              <div className="flex items-center gap-2 text-green-400">
                ...
                <span>Spotify Bağlantısı Gerekli</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-400">Sanatçı Veritabanı</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-400">24h</div>
                <div className="text-gray-400">Yenileme Süresi</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="relative py-16 px-4 bg-gradient-to-b from-gray-900 via-blue-950/30 to-gray-900/80 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800/50 p-8 rounded-2xl border border-gray-700 hover:border-blue-400/50 transition-colors">
              <div className="w-12 h-12 bg-blue-400/20 rounded-lg flex items-center justify-center mb-4">
                <span className="text-2xl">🎵</span>
              </div>
              <h3 className="text-xl font-bold mb-4">Spotify Entegrasyonu</h3>
              <p className="text-gray-300">Spotify hesabınla bağlan ve gerçek müzik verilerine dayalı tahminler yap.</p>
            </div>
